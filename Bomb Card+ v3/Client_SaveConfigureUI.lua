...
function Client_SaveConfigureUI (alert, addCard)
	...
	Mod.Settings.BombCardPlusID = addCard ("Bomb+ Card", strBombPlusDesc, "Bomb card+ v3.png", Mod.Settings.BombPlusPiecesNeeded, Mod.Settings.BombPlusPiecesPerTurn, Mod.Settings.BombPlusStartPieces, Mod.Settings.BombPlusCardWeight);
end