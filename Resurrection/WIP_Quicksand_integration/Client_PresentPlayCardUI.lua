...
function activate_Resurrection (game, cardInstance, playCard)
    ...
    function(rootParent, setMaxSize, setScrollable, game, close)
        ...
        function()
            ...
            print ("[RESURRECTION CARD PLAY ACTIVATE] order input, terr=" .. TargetTerritoryName .. ", Resurrection|PlayCard|" .. tostring (game.Us.ID) .. "|" .. TargetTerritoryID .. "::");

            playCard (strPlayerName_cardPlayer .. " resurrects a Commander on " .. TargetTerritoryName, 'Resurrection|PlayCard|' .. tostring (game.Us.ID) .. "|" .. TargetTerritoryID, WL.TurnPhase.CardsWearOff);
            close();
        end);
    end);
end
