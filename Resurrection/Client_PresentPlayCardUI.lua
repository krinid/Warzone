...
function activate_Resurrection (game, cardInstance, playCard)
    print("[RESURRETION] card play clicked, played by=" .. strPlayerName_cardPlayer .. "::");
    ...
    game.CreateDialog(function(rootParent, setMaxSize, setScrollable, game, close)
        ...
        UI.CreateButton(vert).SetText("Play Card").SetOnClick(function() 
            ...
            print("[RESURRECTION] order input::terr=" .. TargetTerritoryName .. "::Resurrection|" .. TargetTerritoryID .. "::");
            
            if (playCard(strPlayerName_cardPlayer .. " resurrects a Commander on " .. TargetTerritoryName, 'Resurrection|' .. TargetTerritoryID, WL.TurnPhase.Gift)) then
                local orders = game.Orders;
                --table.insert(orders, WL.GameOrderCustom.Create(game.Us.ID, "Resurrects a Commander on " .. TargetTerritoryName, 'Resurrection|'..TargetTerritoryID));

            --code for Server_AdvanceTurn_Order:
