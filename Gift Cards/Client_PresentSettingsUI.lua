function Client_PresentSettingsUI(rootParent)
	...
	UI.CreateLabel (rootParent).SetText ("\n• Max # of buyable cards: " ..tostring (Mod.Settings.MaxBuyableCards ~= nil and Mod.Settings.MaxBuyableCards > 0 and Mod.Settings.MaxBuyableCards or "No limit"));
