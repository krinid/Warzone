...
function createBehemoth (game, order, addNewOrder, targetTerritoryID, goldSpent)
	...
	builder.ModData = "This unit's power scales with the amount of gold used to spawn it. [Cost: " ..tostring (goldSpent).. " gold, Health " ..tostring (behemothPower).. ", Power " ..tostring (behemothPower).. "]";
