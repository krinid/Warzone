...
function Client_PresentSettingsUI(rootParent)
    ...
    if (Mod.Settings.DeneutralizeEnabled == true) then
        ...
        UI.CreateLabel (UImain).SetText("Deneutralize range: " ..tostring ((Mod.Settings.DeneutralizeRange ~= nil and Mod.Settings.DeneutralizeRange < 4000 and Mod.Settings.DeneutralizeRange) or Mod.Settings.DeneutralizeRange) or "Unlimited");
