...
function apply_Poison_Damage_to_Territory (game, intPoisonPlayerID, strOrderDescription, addNewOrder, targetTerritory, impactedTerritory, floatPoisonStrength)
	...
	local intPoisonArmyDamage = math.ceil (-1 * (Mod.Settings.PoisonDamagePercentArmies/100) * floatPoisonStrength - Mod.Settings.PoisonDamageFixedArmies - 0.5); --apply damage %'s -- gets weaker for poison spread away from actual hit location (ground zero/epicenter)
