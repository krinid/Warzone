function Client_PresentSettingsUI (rootParent)
	...
	if (Mod.Settings.PoisonDamageAffectsAllAbilities == true) then UI.CreateLabel (UImain).SetText ("• SU Attack+DefensePower, Attack+DefensePower%, DamageAbsorption are also reduced by Poison effects");
	else UI.CreateLabel (UImain).SetText ("• only Health or Damage To Kill properties are reduced by Poison effects");
	end
