...
function Client_SaveConfigureUI (alert, addCard)
	...
	Mod.Settings.NumCitiesDestroyedByLandminePlay = NIFnumCitiesDestroyedByLandmine.GetValue(); --value of <0 means it would create cities
	--don't need this: Mod.Settings.LandmineImplementationPhase = LandmineImplementationPhase.GetText();
	...
	--so it's easier to just set the Mod.Settings.LandmineImplementationPhase to the numeric value at time of click the desired turn phase
	...
	Mod.Settings.NumCitiesDestroyedByLandminePlay = NIFnumCitiesDestroyedByLandmine.GetValue ();
	...
	Mod.Settings.LandmineCardPlusID = addCard ("Landmine", strLandmineDesc, "Landmine_130x180.png", Mod.Settings.LandminePiecesNeeded, Mod.Settings.LandminePiecesPerTurn, Mod.Settings.LandmineStartPieces, Mod.Settings.LandmineCardWeight);
end