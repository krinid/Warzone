...
function Client_SaveConfigureUI (alert, addCard)
	...
	Mod.Settings.BombCardPlusID = addCard ("Landmine", strBombPlusDesc, "Landmine_130x180.png", Mod.Settings.BombPlusPiecesNeeded, Mod.Settings.BombPlusPiecesPerTurn, Mod.Settings.BombPlusStartPieces, Mod.Settings.BombPlusCardWeight);
end