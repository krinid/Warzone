...
function Client_PresentMenuUI(rootParent, setMaxSize, setScrollable, game, close)
	...
	for k,v in pairs (game.Game.Players) do
		...
		TopLabel.SetText (TopLabel.GetText() .. "\nPlayer "..k .."/"..toPlayerName (k, game)..", State: "..tostring(v.State).."/"..tostring(WLplayerStates ()[v.State]).. ", IsActive: "..tostring(game.Game.Players[k].State == WL.GamePlayerState.Playing).. ", IsAI: " ..tostring (game.Game.Players[k].IsAI).. ", IsAIorHumanTurnedIntoAI: " ..tostring (IsAIOrHumanTurnedIntoAIstrPlayerIsHost).. strPlayerIsHost);
	end
