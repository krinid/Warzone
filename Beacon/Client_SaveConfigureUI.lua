function Client_SaveConfigureUI(alert, addCard)
	...
	local cardID = addCard("Beacon", strDescription, "Beacon_Card.png", Mod.Settings.NumPieces, Mod.Settings.MinPieces, Mod.Settings.InitialPieces, Mod.Settings.CardWeight, Mod.Settings.Duration);
end
