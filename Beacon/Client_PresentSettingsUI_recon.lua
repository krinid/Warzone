function Client_PresentSettingsUI(root)
	UI.CreateLabel(root).SetText('Duration for Recon+ effect: ' ..tostring (Mod.Settings.Duration) .. "      (# of turns the reveal remains)");
	UI.CreateLabel(root).SetText('Range for Recon+ effect: ' ..tostring (Mod.Settings.Range));
