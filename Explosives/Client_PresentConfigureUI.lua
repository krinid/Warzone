...
function Client_PresentConfigureUI (rootParent)
	...
	ExplosivesCardPiecesNeeded = UI.CreateNumberInputField (horzExplosivesCardPiecesNeeded).SetSliderMinValue (1).SetSliderMaxValue (10).SetValue (Mod.Settings.ExplosivesPiecesNeeded or 10).SetWholeNumbers (true).SetInteractable (true);
	...
	ExplosivesCardStartPieces = UI.CreateNumberInputField (horzExplosivesCardStartPieces).SetSliderMinValue (1).SetSliderMaxValue (10).SetValue (Mod.Settings.ExplosivesStartPieces or 1).SetWholeNumbers (true).SetInteractable (true);
	...
	ExplosivesPiecesPerTurn = UI.CreateNumberInputField (horzExplosivesCardPiecesPerTurn).SetSliderMinValue (1).SetSliderMaxValue (10).SetValue (Mod.Settings.ExplosivesPiecesPerTurn or 1).SetWholeNumbers (true).SetInteractable (true);
	...
	ExplosivesCardWeight = UI.CreateNumberInputField (horzExplosivesCardWeight).SetSliderMinValue (0).SetSliderMaxValue (10).SetWholeNumbers (false).SetValue (Mod.Settings.ExplosivesCardWeight or 1).SetInteractable (true);
end
