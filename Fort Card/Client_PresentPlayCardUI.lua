...
function TargetTerritoryClicked()
	...
	TargetTerritoryInstructionLabel.SetText("Please click on the territory you wish to create the fort on.  If needed, you can move this dialog out of the way.");
...
function TerritoryClicked (terrDetails)
    ...
    local terr = terrDetails ~= nil and Game.LatestStanding.Territories [terrDetails.ID] or nil;
